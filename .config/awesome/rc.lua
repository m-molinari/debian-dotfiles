...
--              {description = "view next", group = "tag"}),
    ...
    awful.key({ }, "Print", function () awful.util.spawn("flameshot gui", false) end),
     ...
     -- Screenlock
    awful.key({ altkey, "Control"  }, "l", function () awful.util.spawn("i3lock-fancy", false) end),
...
--              {description = "focus the previous screen", group = "screen"}),
    ...
    -- Menubar
    awful.key({ modkey }, "d", function() awful.util.spawn_with_shell "rofi -show drun -theme Pop-Dark" end,
